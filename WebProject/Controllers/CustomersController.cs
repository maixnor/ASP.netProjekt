...
namespace WebProject.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        {
            if (Session["a"] == null && Session["eid"] == null && (string)Session["cid"] == id) return new HttpStatusCodeResult(HttpStatusCode.Unauthorized);
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
        ...
        {
            if (Session["a"] == null && Session["eid"] == null && (string)Session["cid"] == customer.CustomerID) return new HttpStatusCodeResult(HttpStatusCode.Unauthorized);
            if (ModelState.IsValid)
            {
